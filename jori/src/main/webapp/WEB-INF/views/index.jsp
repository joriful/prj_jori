...
<!--     <div class="container"> -->
    ...
    <div class="container">	    
        <div class="text-center" style="/* border-bottom:solid coral 1px; */ margin-top:5%;">
            <span style="font-weight:bold; color:#404040; font-family:BatangChe; font-size: 48px; /* padding-top:3%; */">조리미의</span>
        ...
        <div class="row">
            <div class="col-md-8 text-center col-centered" style=" margin-bottom:5%; /* padding-top:2%; */">                
                <p class="slogan" style="font-size:20px; color:#696969; margin-top:10px; line-height:1.6em;"> 
                	종가집 전통 장독된장과 청정지역에서 직거래하는 40여가지의</p>
                <p class="slogan" style="font-size:20px; color:#696969; margin-top:10px; line-height:1.6em;"> 
                	신선한 식재료로 한끼의 건강을 책임집니다.</p>	
            </div>
        </div>
